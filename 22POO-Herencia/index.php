...
<body>
    ...
    <main>
        ...
        class Pet
        {
            ...
            protected $name; //nombre color e imagen son atributos privados solo accesible a traves de un getter
            protected $color;
            protected $image; //private solo se puede acceder desde esta clase
            private $adoptionDay; //protected se puede acceder desde las clases herederas (hijas). 
            

            function __construct($animal, $name) //funciona como setter
            {
                $this->animal = $animal;
                $this->name = $name;
            }
            ...
            //funcion privada solo se puede acceder desde animal
