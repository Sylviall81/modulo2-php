...
//seleccionamos todo * de la tabla noticia
...
//Esto para generar las opciones de categorias existentes en los registros;
$query = "SELECT DISTINCT categoria FROM noticia ORDER BY categoria";
$resultCategorias = mysqli_query($conexion, $query);
